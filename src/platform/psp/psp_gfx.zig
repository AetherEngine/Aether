...
fn start_frame(_: *anyopaque) bool { return true; }
fn end_frame(_: *anyopaque) void {}
fn create_pipeline(_: *anyopaque, _: Pipeline.VertexLayout, _: ?[:0]align(4) const u8, _: ?[:0]align(4) const u8) !Pipeline.Handle { return 0; }
fn destroy_pipeline(_: *anyopaque, _: Pipeline.Handle) void {}
fn bind_pipeline(_: *anyopaque, _: Pipeline.Handle) void {}
fn create_mesh(_: *anyopaque, _: Pipeline.Handle) !Mesh.Handle { return 0; }
...
fn create_texture(_: *anyopaque, _: u32, _: u32, _: []const u8) !Texture.Handle { return 0; }
