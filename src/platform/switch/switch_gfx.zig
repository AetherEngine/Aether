//! Switch GPU backend stub.
//!
//! Empty template: every entry point satisfies `gfx_api.Interface` so the
//! engine compiles end-to-end on Switch (`-Dnintendo-switch=true`). Real
//! bring-up will plug libnx's deko3d (or nvgpu via the nv:* services)
//! in here.
