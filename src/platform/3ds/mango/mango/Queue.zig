...
pub const Handle = enum(u32) {
    ...
    pub fn clearColorImage(queue: Handle, info: mango.ClearColorInfo) !void {
        ...
        const clear_scale: usize, const clear_value: FillValue = switch (b_image.info.format) {
            .a8b8g8r8_unorm => .{
                @sizeOf(u32),
    ...
    pub fn clearDepthStencilImage(queue: Handle, info: mango.ClearDepthStencilInfo) !void {
        ...
        const clear_slice, const clear_value: FillValue = switch (b_image.info.format) {
...
pub const FillValue = union(enum) {
    fill16: u16,
    fill24: u24,
    fill32: u32,
};
