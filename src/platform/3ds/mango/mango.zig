...
pub const AetherCtruDeviceCreateInfo = backend.AetherCtru.CreateInfo;

/// Zig entrypoint for creating a device backed by Aether's libctru services.
pub fn createAetherCtruBackedDevice(create_info: AetherCtruDeviceCreateInfo, gpa: std.mem.Allocator) !Device {
