//! 3DS graphics stub.
//!
//! This backend intentionally satisfies the graphics interface without
//! touching the 3DS GPU. It lets the rest of the platform path compile and
//! run while the real Citro3D/PICA200 renderer is still absent.
